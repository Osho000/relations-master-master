...
public class AccountController {
    ...
    @Operation(summary = "Find Account", tags = {"Account"}, description = "Find all Account for users", responses = {
    ...
    @Operation(summary = "Find Account by id", tags = {"Account"}, description = "Find Account by id for users", responses = {
    ...
    @Operation(summary = "Create Account", tags = {"Account"}, description = "Created new Account for users", responses = {
            @ApiResponse(responseCode = "200", description = "Account was created successful")})
    @PostMapping
